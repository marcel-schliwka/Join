...
let responsiveStartEventListener = () => {
  ...
  document.getElementById('dialog__editDeleteBtn').addEventListener('click', () => responsiveDeleteContact())
};
...
function responsiveOpenContact() {
  ...
  document.getElementById('arrowResponsive').classList.remove('d-none');
  document.getElementById('editResponsiveBtn').classList.remove('d-none');
